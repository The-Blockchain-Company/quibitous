...
pub fn explorer_schema_diff_test() {
    ...
    std::process::Command::new(
        "../quibitous-automation/resources/explorer/graphql/generate_schema.sh",
    )
    ...
    quibitous_automation::quibitous::compare_explorer_schema(actual_schema_path.path());
}
...
pub fn explorer_sanity_test() {
    ...
    let (quibitous, initial_stake_pools) =

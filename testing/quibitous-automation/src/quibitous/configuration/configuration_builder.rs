use crate::quibitous::{
    configuration, Block0ConfigurationBuilder, QuibitousParams, QuibitousProcess,
...
use quibitous_lib::interfaces::Block0Configuration;
use quibitous_lib::interfaces::BlockContentMaxSize;
use quibitous_lib::interfaces::InitialToken;
use quibitous_lib::interfaces::ProposalExpiration;
...
pub struct ConfigurationBuilder {
    ...
    consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient,
...
impl ConfigurationBuilder {
    pub fn new() -> Self {
        ConfigurationBuilder {
            ...
            consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient::MAXIMUM,
    ...
    pub fn with_consensus_genesis_optimum_active_slot_coeff(
        &mut self,
        active_slot_coeff: ActiveSlotCoefficient,
    ) -> &mut Self {
        self.consensus_genesis_optimum_active_slot_coeff = active_slot_coeff;
        self
    }
    ...
    pub fn with_trusted_peer(&mut self, node: &QuibitousProcess) -> &mut Self {
        self.node_config_builder
    ...
    pub fn build_block0(&self) -> Block0Configuration {
        ...
        block0_config_builder
            ...
            .with_active_slot_coeff(self.consensus_genesis_optimum_active_slot_coeff)
    ...
    pub fn build(&self, temp_dir: &impl PathChild) -> QuibitousParams<NodeConfig> {

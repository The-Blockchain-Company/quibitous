...
use quibitous_automation::{
    qcli::QCli,
    quibitous::{Block0ConfigurationBuilder, ConfigurationBuilder, QuibitousParams},
};
use quibitous_lib::interfaces::{Block0Configuration, Initial, InitialUTxO, LegacyUTxO};
...
impl Fixture {
    ...
    fn quibitous_params(&self) -> &QuibitousParams {
        &self.params
    }
...
pub fn test_genesis_decode_bijection() {
    ...
    let params = fixture.quibitous_params();
    ...
    let right_hash = qcli.genesis().hash(block0_after.path());

...
use quibitous_lib::interfaces::PeerRecord;

pub fn assert_connected_cnt(node: &QuibitousProcess, peer_connected_cnt: usize, info: &str) {
...
pub fn assert_empty_quarantine(node: &QuibitousProcess, info: &str) {

...
impl TransactionCommand {
    ...
    pub fn make_transaction(
        mut self,
        host: String,
        sender: quibitous_lib::interfaces::Address,
        receiver: Option<quibitous_lib::interfaces::Address>,
        value: quibitous_lib::interfaces::Value,
        block0_hash: String,
        expiry_date: quibitous_lib::interfaces::BlockDate,

...
pub struct OldAddress(bcc_legacy_address::Addr);
...
impl FromStr for OldAddress {
    type Err = bcc_legacy_address::ParseExtendedAddrError;
...
impl AsRef<bcc_legacy_address::Addr> for OldAddress {
    fn as_ref(&self) -> &bcc_legacy_address::Addr {
        &self.0
    }
}
/* ---------------- Conversion --------------------------------------------- */

impl From<bcc_legacy_address::Addr> for OldAddress {
    fn from(v: bcc_legacy_address::Addr) -> Self {
        OldAddress(v)
    }
}

impl From<OldAddress> for bcc_legacy_address::Addr {
...
impl<'de> Deserialize<'de> for OldAddress {
        ...
        D: Deserializer<'de>,
    {
        ...
        bcc_legacy_address::Addr::from_str(&s)
...
mod test {
    ...
    impl Arbitrary for OldAddress {
            ...
            G: Gen,
        {
            ...
            let address =
                bcc_legacy_address::ExtendedAddr::new_simple(&xpub, Arbitrary::arbitrary(g));

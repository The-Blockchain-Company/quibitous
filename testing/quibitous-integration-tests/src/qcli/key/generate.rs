...
pub fn test_ed25519_key_generation() {
    ...
    let generated_key = qcli.key().generate("ed25519");
...
pub fn test_ed25519_uppercase_key_generation() {
    let qcli: JCli = Default::default();
    let generated_key = qcli.key().generate("ED25519EXTENDED");
    assert_ne!(generated_key, "", "generated key is empty");
}
...
pub fn test_ed25510bip32_key_generation() {
    let qcli: JCli = Default::default();
    let generated_key = qcli.key().generate("Ed25519Bip32");
    assert_ne!(generated_key, "", "generated key is empty");
}
...
pub fn test_curve25519_2hashdh_key_generation() {
    let qcli: JCli = Default::default();
    let generated_key = qcli.key().generate("RistrettoGroup2HashDh");
    assert_ne!(generated_key, "", "generated key is empty");
}
...
pub fn test_sumed25519_12_key_generation() {
    let qcli: JCli = Default::default();
    let generated_key = qcli.key().generate("SumEd25519_12");
    assert_ne!(generated_key, "", "generated key is empty");
}
...
fn test_key_invalid_seed_length(seed: &str) {
    let qcli: JCli = Default::default();
    qcli.key().generate_with_seed_expect_fail(
        "Ed25519Extended",
        seed,

...
use quibitous_automation::quibitous::{FragmentNode, MemPoolCheck};
use quibitous_automation::testing::{
    ensure_node_is_in_sync_with_others, SyncNode, SyncNodeError, SyncWaitParams,
};
use quibitous_lib::{crypto::hash::Hash, interfaces::FragmentStatus};
...
pub enum AdversaryFragmentSenderError {
    ...
    FragmentNotRejected {
        alias: String,
        date: quibitous_lib::interfaces::BlockDate,
        block: Hash,
        #[debug(skip)]
        logs: Vec<String>,
    },

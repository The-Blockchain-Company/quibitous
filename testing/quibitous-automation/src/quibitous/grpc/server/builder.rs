use super::{QuibitousServerImpl, MockController, MockLogger, MockServerData, ProtocolVersion};
use crate::quibitous::configuration::get_available_port;
use crate::quibitous::grpc::server::NodeServer;
...
impl Default for MockBuilder {
    fn default() -> Self {
        Self {
            mock_port: None,
            genesis_block: None,
            protocol_version: ProtocolVersion::GenesisOptimum,
    ...
    std::thread::spawn(move || {
        ...
        tracing::subscriber::with_default(subscriber, || {
            ...
            rt.block_on(async move {
                let mock = QuibitousServerImpl::new(data_clone);
                Server::builder()

...
pub use quibitous_lib::interfaces::{Cors, Mempool, Rest, Tls};
use quibitous_lib::multiaddr;
...
fn resolve_trusted_peers(peers: &[quibitous_lib::interfaces::TrustedPeer]) -> Vec<TrustedPeer> {
    peers
        .iter()

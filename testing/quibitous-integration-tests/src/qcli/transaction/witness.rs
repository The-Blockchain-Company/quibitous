...
use quibitous_automation::qcli::{Witness, WitnessData, WitnessType};
...
pub fn test_utxo_transation_with_address_type_witness_is_rejected() {
    ...
    // FIXME: this is not a sensible behavior. Ideally qcli should reject such
...
pub fn test_make_witness_with_invalid_private_key_fails() {
    ...
    let mut private_key = qcli.key().generate_default();
    private_key.push('3');

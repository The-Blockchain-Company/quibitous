...
impl Blockchain {
    ...
    pub fn consensus_genesis_optimum_active_slot_coeff(&self) -> &ActiveSlotCoefficient {
        &self.consensus_genesis_optimum_active_slot_coeff
    }
    ...
    pub fn with_consensus_genesis_optimum_active_slot_coeff(
        ...
        self.consensus_genesis_optimum_active_slot_coeff = coeff;
        self
    }
...
impl Default for Blockchain {
    fn default() -> Self {
        Self {
            ...
            committees: Vec::new(),
            consensus: ConsensusVersion::GenesisOptimum,
            consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient::new(
...
impl BlockchainBuilder {
    ...
    pub fn consensus_genesis_optimum_active_slot_coeff(
        mut self,
        coeff: ActiveSlotCoefficient,
    ) -> Self {
        self.blockchain = self
            .blockchain
            .with_consensus_genesis_optimum_active_slot_coeff(coeff);
        self
    }

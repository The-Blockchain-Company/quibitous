...
use crate::quibitous::QuibitousRest;
pub use fragment_log::{assert_accepted_rejected, assert_bad_request, FragmentLogVerifier};
use quibitous_lib::interfaces::{AccountState, Address, Value};

pub struct QuibitousStateVerifier {
    rest: QuibitousRest,
    snapshot_before: Option<StateSnapshot>,
}

impl QuibitousStateVerifier {
    pub fn new(rest: QuibitousRest) -> Self {
        Self {
            rest,
...
fn as_identifier(address: &Address) -> quibitous_lib::crypto::account::Identifier {

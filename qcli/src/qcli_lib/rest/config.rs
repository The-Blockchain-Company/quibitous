...
pub struct RestArgs {
    ...
    /// E.g. `-h http://127.0.0.1`, `--host https://node.com:8443/bcc/api`
    #[structopt(short, long, env = "QUIBITOUS_RESTAPI_URL")]
    pub host: Url,
    ...
    #[structopt(long, name = "PATH", env = "QUIBITOUS_TLS_CERT_PATH")]

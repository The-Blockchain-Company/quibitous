...
impl From<&ContainerTypeLib> for ConsensusType {
    fn from(v: &ContainerTypeLib) -> Self {
        match v {
            ...
            ContainerTypeLib::GenesisOptimum => Self {
                consensus_type: ConsensusTypeEnum::GenesisOptimum,
            },
        }
    }
}
...
pub enum ConfigParam {
    ...
    ConsensusGenesisOptimumActiveSlotsCoeff(Milli),
...
impl From<&ConfigParamLib> for ConfigParam {
    fn from(v: &ConfigParamLib) -> Self {
        match v {
            ...
            ConfigParamLib::ConsensusGenesisOptimumActiveSlotsCoeff(v) => {
                Self::ConsensusGenesisOptimumActiveSlotsCoeff(v.into())
            }

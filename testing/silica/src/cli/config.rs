...
use quibitous_automation::quibitous::RestSettings;
...
impl Into<QuibitousRest> for Connection {
    fn into(self) -> QuibitousRest {
        QuibitousRest::new_with_custom_settings(self.address.clone(), self.into())
    }
}

...
pub struct BlockchainConfiguration {
    ...
    #[serde(default)]
    pub consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient,
...
impl BlockchainConfiguration {
    pub fn new(
        ...
        BlockchainConfiguration {
            ...
            consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient::default(),
    ...
    fn from_config_params(params: ConfigParams) -> Result<Self, FromConfigParamsError> {
        ...
        let mut consensus_genesis_optimum_active_slot_coeff = None;
        ...
        for param in params.iter().cloned() {
            match param {
                ...
                cp @ ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(_) => {
                    consensus_genesis_optimum_active_slot_coeff
                        .replace(cp.try_into()?)
                        .map(|_| "consensus_genesis_optimum_active_slot_coeff")
                }
        ...
        Ok(BlockchainConfiguration {
            ...
            consensus_genesis_optimum_active_slot_coeff: consensus_genesis_optimum_active_slot_coeff
                .ok_or_else(|| param_missing_error("consensus_genesis_optimum_active_slot_coeff"))?,
    ...
    fn into_config_params(self) -> ConfigParams {
        ...
        params.push(ConfigParam::from(consensus_genesis_optimum_active_slot_coeff));
        ...
        fn arbitrary<G: Gen>(g: &mut G) -> Self {
            ...
            BlockchainConfiguration {
                ...
                block0_consensus: if bool::arbitrary(g) {
                    ...
                    ConsensusVersion::GenesisOptimum
                },
                linear_fees,
                ...
                consensus_genesis_optimum_active_slot_coeff: ActiveSlotCoefficient::arbitrary(g),

...
pub fn test_legacy_node_all_fragments() {
    ...
    let quibitous = Starter::new()
        .temp_dir(temp_dir)
        .quibitous_app(quibitous)
        .legacy(legacy_release.version())
        .config(config)
        .start()
        .expect("cannot start legacy quibitous");
    ...
    fragment_sender
        .send_fragment(&mut first_stake_pool_owner, fragment, &quibitous)
    ...
    fragment_sender
        .send_fragment(&mut second_stake_pool_owner, fragment, &quibitous)
    ...
    fragment_sender
        .send_fragment(&mut full_delegator, fragment, &quibitous)
        .unwrap();
    ...
    fragment_sender
        .send_fragment(&mut split_delegator, fragment, &quibitous)
        .unwrap();

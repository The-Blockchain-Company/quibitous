...
use quibitous_automation::quibitous::{LogLevel, Version};
...
impl SpawnParams {
    ...
    pub fn quibitous(mut self, quibitous_app_path: PathBuf) -> Self {
        self.quibitous = Some(quibitous_app_path);
        self
    }
    ...
    pub fn get_quibitous(&self) -> &Option<PathBuf> {
        &self.quibitous
    }

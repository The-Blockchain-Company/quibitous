...
use crate::quibitous::legacy::config::NodeConfig;
use crate::quibitous::QuibitousParams;
use crate::quibitous::{legacy::version_0_13_0, Version};
use quibitous_lib::interfaces::NodeId;
use quibitous_lib::interfaces::{NodeConfig as NewestNodeConfig, Rest};
use rand::RngCore;
use rand_core::OsRng;
use thiserror::Error;
#[derive(Error, Debug)]
...
impl LegacyConfigConverter {
    ...
    pub fn convert(
        &self,
        params: QuibitousParams<NewestNodeConfig>,
    ) -> Result<QuibitousParams<NodeConfig>, LegacyConfigConverterError> {

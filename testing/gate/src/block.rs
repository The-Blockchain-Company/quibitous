...
use quibitous_lib::crypto::key::SigningKey;
...
impl BlockBuilder {
    ...
    pub fn genesis_optimum(block_date: BlockDate, parent_block_header: Header) -> Self {
        Self {
            block_date,
            consensus_protocol: ConsensusVersion::GenesisOptimum,
            contents: None,
            signing_key: None,
            invalid_hash: false,
            invalid_signature: false,

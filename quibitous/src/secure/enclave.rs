use crate::blockcfg::{
    BlockDate, HeaderBft, HeaderBftBuilder, HeaderGenesisOptimum, HeaderGenesisOptimumBuilder,
...
impl Enclave {
    ...
    pub fn create_header_genesis_optimum(
        &self,
        header_builder: HeaderGenesisOptimumBuilder<HeaderSetConsensusSignature>,
    ) -> Option<HeaderGenesisOptimum> {
        let leader = self
            .leader_data
            .as_ref()
            .as_ref()?
